    ...
    <div class="shadow rounded-4 p-4 bg-white" style="border: 1px solid #e3e6f0;">
        ...
        @if ($data)
            <div class="mb-4 p-3 rounded-3" style="background: #f0f5ff; border-left: 5px solid #3b82f6;">
                ...
                <p class="mb-0" style="font-size: 1.1rem; font-weight:700; color:#1e40af;">{{ $data->nama_siswa ?? 'Nama tidak tersedia' }}</p>
        ...
        <form action="{{ route('ortu.kirimPresensi') }}" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-4">
                <label for="tanggal" class="form-label fw-semibold" style="letter-spacing: 0.04em;">Tanggal Izin <span class="text-danger">*</span></label>
                <input 
                    type="date" 
                    id="tanggal" 
                    name="tanggal" 
